...
Project note: this repository owns independent Minify++ HTML evidence. Keep WPT outside git, retain exact revisions in result JSON, and do not count DOM-oracle differences as product bugs until triaged. The initial oracle excludes fragment-context tests and conservatively normalizes comments and formatting whitespace while preserving raw-text/preformatted content.
